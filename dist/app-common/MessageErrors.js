...
const MessageErrors = {
    field: {
        ...
        authentication: {
            invalid: "errors.field.authentication.invalid",
            isExist: "errors.field.authentication.isExist",
        },
        phoneNumber: {
    ...
    order: {
        ...
        empty: "errors.field.id.empty",
    },
    boxslot: {
        notHaveAvailable: "error.boxslot.notHaveAvailable",
        bookBoxSlotInValid: "error.boxslot.bookBoxSlotInValid",
    },
    payment: {
        paymentThan3Order: "error.order.paymentThan3Order",
        paymentCheckOrder: "error.order.paymentCheckOrder",
    },
    thirdParty: {
    ...
    banner: {
        ...
        status: "status must be: -1: Hidden, 0: Ongoing, or 1: Pending, 2 or Stoping",
    },
    article: {
    ...
    boxTemplate: {
        type: "errors.typeBoxTemplate.empty",
    },
    box: {
        status: "Box status is incorrect: 1 for available, 2 for unavailable",
        notFound: "errors.box.notFound",
        invalid: "errors.field.string.invalid",
        duplicateCode: "errors.box.code.duplicate",
    },
};
exports.default = MessageErrors;
